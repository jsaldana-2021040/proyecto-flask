...
permisosModel = api.model('PermisosModel',{
    ...
    'modulo': fields.Nested(modulosModel)
})
...
rolBodyRequestModel = api.model('RolBodyRequestModel',{
    'nombre' : fields.String,
    'descripcion' : fields.String,
    'permisos': fields.List(fields.Integer, required=False)
})

rolPgModel = api.model('rolPgModel', {
    'total': fields.Integer,
    'page': fields.Integer,
    'pages': fields.Integer,
    'items': fields.List(fields.Nested(rolModel))
})
